...
% This is made possible by introducing a small hyperdiffusive term which dampens the growth of floating point errors at small-scale modes \cite{qrmsource}.
...
% QRM (described in section II) deals with the ill-posed problem term by introducing a higher-order hyperdiffusive term whose coefficient $\varepsilon$ is small.
...
% The hyperdiffusive terms we employed with QRM relax these unstable modes allowing us to perform something akin to the idealized backward integration.
